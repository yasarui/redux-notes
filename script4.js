...
let store = Redux.createStore(Redux.combineReducers({counterReducer,todoReducer}));
...
//In an application we can have any number of reducers ,we combine all them with combine reducers